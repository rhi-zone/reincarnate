...
| Game | Source | Status |
|------|--------|--------|
| 10 Second Ninja X | `data.win` 134MB | ⚠️ 474 TS errors (2026-03-14) |
...
| Schism | `data.win` 77MB | ⚠️ 494 TS errors (2026-03-14) |
...
| VA-11 HALL-A | `game.unx` 212MB | ⚠️ 60 TS errors (2026-03-14) |
