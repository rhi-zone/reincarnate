//! Control-flow rewrite passes: ternary, min/max, for-each, loop-to-while,
//! logical operator simplification, and output node lowering.

use super::super::ast::{Expr, Stmt};
use super::super::inst::CmpKind;
use super::super::ty::Type;
use super::super::value::Constant;
use super::recurse_into_stmt;
