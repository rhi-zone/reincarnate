...
Winnow is a framework for lifting legacy software from obsolete runtimes into modern web-based equivalents.
...
Winnow works on **bytecode and script**, not native binaries.
