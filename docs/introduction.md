...
Siphon is a framework for lifting legacy software from obsolete runtimes into modern web-based equivalents.
...
Siphon works on **bytecode and script**, not native binaries.
